...
const SCREEN_CATEGORIES = {
  ...
  'AI Plan Screens': [
    { name: 'Generating Plan', route: '/(tabs)/generating_plan', icon: 'psychology', description: 'AI plan generation in progress', status: 'ready' },
    { name: 'Plan Review', route: '/(tabs)/plan_review', icon: 'hourglass-top', description: 'Plan pending coach approval', status: 'ready' },
    { name: 'Weekly Plan', route: '/(tabs)/plan', icon: 'calendar-today', description: 'View weekly AI plan overview', status: 'ready' },
  ],
};
